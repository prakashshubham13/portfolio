	...
	<div class="container">
		...
		<div class="header">
			...
			<ul id="myDIV">
				...
				<li ><a href="v.html" class="activee"  class="tablinks"  id="defaultOpen">ABOUT</a></li>
				<li><a href="skill.html"  class="tablinks" onclick="openCity(event, 'Paris')">SKILLS</a></li>
				<li><a href="#"  class="tablinks" onclick="openCity(event, 'Tokyo')">PROJECTS</a></li>
			<li><a href="#"  class="tablinks" onclick="openCity(event, 'Japan')">CONTACT</a></li>
